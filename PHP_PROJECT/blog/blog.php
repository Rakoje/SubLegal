...
<div class="row project-bg" style="margin: 0">
    <div class="col-sm-12 home-box-text">
        <div id="center-on-mobile"><h1 style="font-size: 25px"><?php echo $latest_label ?></h1></div>
        <div class="row ">
            <div class="col-sm-12">
                <!-- Project Cards -->
                <?php
                if ($language == "rs") { ?>
                    <a href="<?php echo $latest_link ?>" style="text-decoration: none; color:black" target="_blank">
                        <div class=" m-3 project-card">
                            ...
                            <div class="card-body">
                                ...
                                <a href="<?php echo $latest_link; ?>" style="text-decoration: none" target="_blank"
