...
<div class="row home-bg" style="margin: 0">
    <div class="col-sm-12 home-box-text">
        ...
        <br>
        <div>
            U SubLegal-u, posvećujemo se pružanju vrhunskih pravnih ekspertiza koje obezbeđuju rešenja prilagođena Vašim specifičnim
            potrebama. Naša advokatska firma okuplja tim stručnjaka koji pokrivaju širok spektar pravnih oblasti, pružajući
            ...
            <div class="card card-real-estate">
                <a href="real_estate.php">
                    ...
                    <div class="limited-text">
                        ...
                        Gori, sa akcentom na Beograd i crnogorsko primorje. Pružamo celokupnu pravnu uslugu u navedenoj
                        oblasti - od pregovora, posredovanja, procene rizika, pa do izrade celokupne dokumetacije kada
                        su u pitanju kupoprodaje, investiranje, gradnja, adaptacije, legalizacija, otuđivanje, prenamene
            ...
            <div class="card card-corporate">
                <a href="corporate.php">
                    <img src="../assets/account_balance_FILL0_wght400_GRAD200_opsz48.png" class="icons no-hover-img"
                         alt="">
                    <img src="../assets/account_balance_FILL0_wght400_GRAD200_opsz48 belo.png" class="icons hover-img"
                         alt="">
                    ...
                    <div class="limited-text">
                        ...
                        oblasti poslovanja.
                        Pružamo kako pravne, tako i konsultatske usluge kompanijama i grupacijama dugi niz godina koje
                        posluju na teritoriji Srbije, Crne Gore i Hrvatske. Od njihovog samog osnivanja, pratimo rast i
                        razvoj kompanija sa aktivnim učešćem u tranzicionim i kadrovskim procesima kroz koje prolaze i
                        pružamo im različite vrste usluga iz oblasti pravne usluge, finansisjog savetovanja,
                        knjigovodstva i HR sektora. Pružamo uslugu svih vrsta procena – „Due diligence” u cilju kupovine
            ...
            <div class="card card-tax-law">
                <a href="tax_law.php">
                    ...
                    <div class="limited-text">
                        ...
                        Našim klijentima pružamo sveobuhvatnu uslugu usklađivanja poreske politike sa ciljem stvaranja
        ...
        <div class="col-sm-3">
            <div class="card card-immigration">
                <a href="immigration.php">
                    ...
                    <h2>Imigracija</h2>
                    <div class="limited-text">
                        Svesni toga da postoji toliko raznih aspekata kada porodice ili pojedinci odluče da se presele u
                        drugu zemlju, ovoj grani prava pristupamo sa najviše empatije. Proces imigracije često može biti
                        emotivno i teško putovanje kako zbog brzo promenljive prirode zakona koji regulišu ovu oblast u
                        Republici Srbiji, tako i zbog složenih pravnih pitanja koja se mogu pojaviti u postupcima pred
                        ...
                        zaposli radnike nerezidente, mi pružamo savete i pravnu pomoć kako bismo vam na najbolji mogući
            ...
            <div class="card card-intellectual">
                <a href="intellectual.php">
                    ...
                    <div class="limited-text">
                        ...
                        karijere i trudimo se da klijentima prenesemo njen značaj. Danas je taj značaj u svakom slučaju
                        veći nego ikada imajući u vidu napredak tehnologije. Posebno ističemo to da je jako bitan faktor
                        ekonomskog razvoja za kompanije , rasta poslovanja i konkurentnosti, kao i pokretačku snaga
                        inovacije, te je potrebno na vreme zaustaviti zloupotrebe i zaštiti svoju intelektualnu svojinu.
                    </div>
                </a>
            </div>
        </div>
        <div class="col-sm-3">
            <div class="card card-employment">
                <a href="employment.php">
                    ...
                    <h2>Radni odnosi</h2>
                    <div class="limited-text">Kao neizostavan segment privrede i korporativnog poslovanja, radni odnosi
                        igraju, prema našem mišljenju, najznajčajniju ulogu u postavljanju temelja za uspešno vođenje
                        ...
                        statusa zaposlenih i neophodnosti pedantnog odnosa na relaciji poslodavac – zapsoleni. S toga
        ...
        <div class="col-sm-3">
            <div class="card card-l-e">
                <a href="litigation_enforcement.php">
                    ...
                    <div class="limited-text">Kao neizostavan deo uspešne pravne pomoći predstavlja zastupanje klijenata
                        ...
                        pristupamo svakom pojedinačnom slučaju u cilju uspešnog rešavanja spora, čiji ishodi su neretko
                        od vitalne važnosti za stranku u postupku. Smatramo da je pronalaženje načina da se spor izbegne
                        i aktivno učešće u pregovorima jednako važno kao i zastupanje pred sudom, kako u parničnom, tako
