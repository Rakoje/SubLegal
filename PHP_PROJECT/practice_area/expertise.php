...
if ($language == "rs") {
    $title = "EKSPERTIZA";
    $subtitle = "Pružamo idealnu kombinaciju striktnog znanja i opuštenog pristupa.";
    $dalje = "DALJE";
    ...
    $title = "EXPERTISE";
    $subtitle = "We provide the ideal combination of strict knowledge and a relaxed approach.";
    $dalje = "CONTINUE";
...
<div class="row expertise-bg" style="margin: 0">
    <div class="col-sm-12 expertise-box-text">
        ...
        <br>
        <div>
            <a href="#dalje" style="text-decoration: none"> - <?php echo $dalje; ?></a>
        </div>
    </div>
</div>
